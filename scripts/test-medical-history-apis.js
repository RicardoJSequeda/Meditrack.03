...
async function testMedicalHistoryAPIs() {
  console.log('🧪 Probando APIs del historial médico...\n')
  ...
  console.log('4. Prueba las diferentes pestañas (Diagnósticos, Tratamientos, etc.)')
  console.log('5. Verifica que la búsqueda y filtros funcionan')
}

testMedicalHistoryAPIs() 