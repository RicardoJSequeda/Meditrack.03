...
async function testReportsIntegration() {
  console.log('🧪 Probando integración de informes...\n')
  ...
  console.log('2. Navega a la página de Informes/Historial')
  console.log('3. Verifica que los datos se cargan desde la base de datos')
  console.log('4. Prueba los gráficos y métricas')
  console.log('5. Verifica que las recomendaciones aparecen')
}
