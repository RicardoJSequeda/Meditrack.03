...
try {
  ...
  console.log('✅ Archivo .env actualizado con la URL de conexión directa correcta!')
  console.log('🔗 URL de conexión: postgresql://postgres:Erika03n1!111111111111111111@db.hyrxpkdfosnmdpphlkqq.supabase.co:5432/postgres')
  console.log('🌐 NEXTAUTH_URL actualizado a: http://localhost:3001')
