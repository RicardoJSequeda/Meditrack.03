...
try {
  ...
  console.log('✅ Archivo .env actualizado con la URL de conexión directa!')
  console.log('🔗 URL de conexión: postgresql://postgres:Erika03n1!@db.hyrxpkdfosnmdpphlkqq.supabase.co:5432/postgres')
