...
const content = `DATABASE_URL="postgresql://postgres:Erika03n1!@db.hyrxpkdfosnmdpphlkqq.supabase.co:5432/postgres"
...
try {
  ...
  console.log('✅ Archivo .env.local actualizado con las nuevas credenciales de Meditrack!')
  console.log('📋 Nuevas credenciales:')
  console.log('   - Project URL: https://hyrxpkdfosnmdpphlkqq.supabase.co')
  console.log('   - Database: Meditrack')
  console.log('   - Password: Erika03n1!')
} catch (error) {
